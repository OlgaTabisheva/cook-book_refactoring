      ...
      <div className={style.popupMenu_visible__component}>
        ...
        <div className={style.popupMenu_visible__box}>
          ...
          <nav className={style.popupMenu_visible__links}>
            ...
            <LinkItem popupMenu={popupMenu} setPopupMenu={setPopupMenu} linkTo={'/recipes'} text={'Рецепты'}
                      active={active}/>
            <LinkItem popupMenu={popupMenu} setPopupMenu={setPopupMenu} linkTo={'/authors'} text={'Авторы'}
                      active={active}/>
            <LinkItem popupMenu={popupMenu} setPopupMenu={setPopupMenu} linkTo={'/add-recipe-step'}
                      text={'Добавить новый рецепт'} active={active}/>
