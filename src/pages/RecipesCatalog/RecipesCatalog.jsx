    ...
    <div className={style.recipesCatalog}>
      ...
      <div className={style.recipesCatalog__box}>
        ...
        {allCategories?.categories?.map((obj) => (
          <ButtonChips key={obj.number} text={obj ? obj?.category : ''} onClick={() => handleOnClick(obj)}
                       chosenText={chosenTextCategoryLocal?.category}></ButtonChips>
        ))}
      ...
      <div className={style.recipesCatalog__boxCatalog}>
        ...
        {((selectedCategory > 0) ? chosenCategory?.recipes?.length : instantAddRecipe?.recipes?.length) > 21 &&
