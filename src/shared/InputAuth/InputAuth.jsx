...
console.log(error, 'error',errorText, 'errorText')
  return (
    <div className={style.inputAuth } {...props}>
      ...
      <input required={required} className={style.inputAuth__input} type={password && "password"} id={id} name={name} placeholder={placeholder} defaultValue={value} onChange={onChange}/>
