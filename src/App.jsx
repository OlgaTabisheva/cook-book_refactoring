...
function App() {
  ...
  const [instantAddRecipeUnpublish, setInstantAddRecipeUnpublish] =
    React.useState();
...
`;
  ...
  const likesCommentsFromServer =
    useQuery(GET_LIKES_COMMENTS).data?.likesComments;
  ...
  return (
    <div className="app">
      <Routes>
        ...
        <Route exact path="/authors" element={<MainLayout />}>
          <Route
            path="/authors"
            element={
              <ProtectedRoute>
        ...
        <Route exact path="/search/:searchValue" element={<MainLayout />}>
          <Route
        ...
        <Route exact path="/recipes" element={<MainLayout />}>
          <Route
            path="/recipes"
            element={
              <RecipesCatalog
        ...
        />
        <Route exact path="/admin/:title" element={<MainLayout />}>
          <Route
            path="/admin/:title"
            element={
              <ProtectedRoute>
                <AdminPage allCategories={allCategories} />
              </ProtectedRoute>
            }
          />
        </Route>
        <Route exact path="/user" element={<MainLayout />}>
          <Route
            path="/user"
            element={
              <ProtectedRoute>
        ...
        <Route exact path="/recipe/:id" element={<MainLayout />}>
          <Route
            path="/recipe/:id"
            element={
              <FullRecipe
